            ...
            // Dashboards
            {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        loadChildren: () =>
                            import(
                                'app/modules/admin/apps/app-demandeAchat/demandeAchatComponent/demande-achat.routes'
                            ),
                    },
                    {
                        path: 'Add-article',
                        loadChildren: () =>
                            import(
                                'app/modules/admin/apps/app-articles/add-article/add-article.routes'
                            ),
                    },
                    {
                        path: 'commande',
                        loadChildren: () =>
                            import(
                                'app/modules/admin/apps/app-commande/commande/commande.routes'
                            ),
                    },
                    {
                        path: 'commandeDialog',
                        loadChildren: () =>
                            import(
                                'app/modules/admin/apps/app-commande/commande-dialog/commande-dialog.routes'
                            ),
                    },
                    {
                        path: 'article',
                        loadChildren: () =>
                            import(
                                'app/modules/admin/apps/app-articles/article/article.routes'
                            ),
                    },
                    {
                    path: 'evaluation',
                    loadChildren: () =>
                        import(
                            'app/modules/admin/apps/app-fournisseur/evaluation_fournisseur/evaluationsfournisseur/evaluation.routes'
                        ),
                    },
                    {
                        path: 'devis',
                        loadChildren: () =>
                            import(
                                'app/modules/admin/apps/app-devis/devis/devis.routes'
                            ),
                    },
                    {
                        path: 'devisDialog',
                        loadChildren: () =>
                            import(
                                'app/modules/admin/apps/app-devis/devis-dialog/devis-dialog.routes'
                            ),
                    },
                    {
                        path: 'fournisseur',
                        loadChildren: () =>
                            import(
                                'app/modules/admin/apps/app-fournisseur/Fournisseur/fournisseur.routes'
                            ),
                    },
                    {
                        ...
                        loadChildren: () =>
                            import(
                                'app/modules/admin/apps/app-fournisseur/add-fournisseur/add-fournisseur.routes'
                            ),
                    },
                    {
                        path: 'comptes',
                        ...
                        children: [
                            {
                                ...
                                loadChildren: () =>
                                    import(
                                        'app/modules/admin/apps/app-user/users/users.routes'
                                    ),
                            },
                            {
                                path: 'roles',
                                loadChildren: () =>
                                    import(
                                        'app/modules/admin/apps/app-roles/roles/roles.routes'
                                    ),
                            },
                        ],
                    },
